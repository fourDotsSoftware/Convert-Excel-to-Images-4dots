...
namespace ExcelToImagesConverter4dots
{
    class Module
    {
        ...
        public static string ApplicationName = "Convert Excel To Images 4dots";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/ExcelToImagesConverter/";
        public static string HelpURL = "https://www.4dots-software.com/excel-to-images-converter/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/excel-to-images-converter/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-excel-to-images-converter.php";
        public static string VersionURL = "http://cssspritestool.com/versions/excel-to-images-converter.txt";

        public static string TipText = TranslateHelper.Translate("Great application to Convert Excel to Images !");        
